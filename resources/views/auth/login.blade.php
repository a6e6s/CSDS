                        ...
                        <div class="row g-0">
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('home') }}" class="">
                                            ...
                                            <h4 class="mt-1 mb-5 pb-1 h6">سجّل دخولك الآن للوصول إلى ملفك الطبي وحجز
                                                الكشف بسهولة</h4>
                                        </a>
                                    </div>
                                    ...
                                    <form action="{{ route('signin') }}" method="POST">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <a href="{{ route('register') }}" class="btn btn-outline-primary"> انشاء
                                                حساب جديد </a>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h4 class="mb-4">رعايتك الصحية تبدأ من هنا .</h4>
                                    <p class="small mb-0">
                                        نوفر لك منصة شاملة للبحث عن أفضل الأطباء، حجز الكشفوات عبر الإنترنت، وتخزين ملفك
                                        الطبي بشكل آمن. كل ما تحتاجه لرعاية صحية أفضل في مكان واحد! </p>
                                </div>
                            </div>
                        </div>
                    </div>
