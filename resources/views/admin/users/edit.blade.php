                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="{{ $user->name }}" name="name" type="text" placeholder="@lang('User name')" aria-label="name" id="name">
                            @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="" name="password" type="password" placeholder="@lang('Password')" aria-label="password" id="password">
                            @error('password')
                                <span class="break p-2 text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="" name="password_repeat" type="password" placeholder="@lang('Password repeat')" aria-label="password_repeat" id="password_repeat">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <input {{ $user->status != '0' ? 'checked' : '' }} class="btn-check" id="active" type="radio" value="1" name="status">
