...
@section('content')
    <div class="row">
        <div class="text-end pb-2">
            <a href="{{ route('offers.index') }}" class="col btn-sm btn btn-danger"><i class="icofont-undo"></i>
                @lang('Go back')</a>
        </div>
    </div>
    <form action="{{ route('offers.store') }}" method="post" class="row" enctype="multipart/form-data">
        @csrf
        @method('POST')
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" onchange="updateInput()" value="{{ old('title') }}" name="title"
                                type="text" placeholder="@lang('Title')" aria-label="title" id="title">
                            @error('title')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="{{ old('new_price') }}" name="new_price" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="{{ old('start_at') }}" name="start_at" type="date"
                                placeholder="@lang('Start at')" aria-label="start_at" id="start_at">
                            @error('start_at')
                                <span class="break p-2 text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="{{ old('end_at') }}" name="end_at" type="date"
                                placeholder="@lang('Ends at')" aria-label="end_at" id="end_at">
                            @error('end_at')
                                <span class="break p-2 text-danger">{{ $message }}</span>
                            @enderror
                        </div>
