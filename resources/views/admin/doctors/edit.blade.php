...
@section('content')
    ...
    <form action="{{ route('doctors.update', $doctor) }}" method="post" class="row" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-lg-9 pb-2">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        <div class="col-md-3">
                            <label class="title" for="title">@lang('Doctor title')</label>
                            <div class="input-group mb-3">
                                <input class="form-control" value="{{ $doctor->title }}" name="title" type="text"
                                    placeholder="@lang('Doctor title')" aria-label="title" id="title">
                                @error('title')
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" value="{{ $doctor->name }}" name="name" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="{{ $doctor->email }}" name="email" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" value="" name="password_repeat" type="password"
                                placeholder="@lang('Password repeat')" aria-label="password_repeat" id="password_repeat">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select " name="city_id" id="city_id">
                            ...
                            @foreach ($cities as $city)
                                <option @selected($city->id == $doctor->city_id) value="{{ $city->id }}">{{ $city->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select " name="hospital_id" id="hospital_id">
                            ...
                            @foreach ($hospitals as $hospital)
                                <option @selected($hospital->id == $doctor->hospital_id) value="{{ $hospital->id }}">{{ $hospital->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select " name="specialty_id" id="specialty_id">
                            ...
                            @foreach ($specialties as $specialty)
                                <option @selected($specialty->id == $doctor->specialty_id) value="{{ $specialty->id }}">{{ $specialty->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check mb-3">
                            <input {{ $doctor->status == '0' ? 'checked' : '' }} class="btn-check" id="blocked"
                            ...
                            <input {{ $doctor->status != '0' ? 'checked' : '' }} class="btn-check" id="active"
